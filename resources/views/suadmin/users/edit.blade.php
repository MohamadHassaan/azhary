...
@endif
      ...
      <form role="form" action="{{route('users.update',['id'=>$users->id])}}" method="POST" enctype="multipart/form-data">
            @csrf
          <div class="card-body">
            <div class="form-group">
                <label for="exampleInputEmail1">ادخل الاسم</label>
            <input type="text" class="form-control" name="name" value="{{$users->name}}" id="inputname" placeholder="Enter Your Name">
              </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="password" value="" id="InputPassword1" placeholder="Change Password">
            </div>
            <div class="form-group">
              ...
              <div class="card card-default">
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label>تغيير نوع المستخدم</label>
                        <select class="form-control select2" name="role" style="width: 100%;">
                        
                          <option selected="selected" value="{{$users->role}}" ></option>
                      ...
                      <div class="form-group">
                        <div class="custom-control custom-switch custom-switch-1-danger custom-switch-0-success ">
